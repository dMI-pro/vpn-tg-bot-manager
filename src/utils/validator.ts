/**
 * Валидация IP адреса (v4 или v6) или доменного имени
 */
...
/**
 * Валидация имени устройства (WireGuard config name)
 */
...
/**
 * Проверка прав на редактирование VPS
 */
export function validateVPSEditable(vps: any, userTelegramId: number): boolean {
  return vps && vps.user_telegram_id === userTelegramId;
}
